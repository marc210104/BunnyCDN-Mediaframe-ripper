...
if __name__ == "__main__":
    video = BunnyVideoDRM(
        ...
        referer="https://iframe.mediadelivery.net/embed/279029/04ec90db-6dcc-4e01-81ce-7761a80e72ba?autoplay=true&loop=false&muted=false&preload=true&responsive=true&expires=1745957829&token=b332a2547ee3e5d878891aa73827629b882466302f0824e220ff4c4f3174e9bf",
        # paste your embed link
        embed_url="https://iframe.mediadelivery.net/embed/279029/04ec90db-6dcc-4e01-81ce-7761a80e72ba?autoplay=true&loop=false&muted=false&preload=true&responsive=true&expires=1745957829&token=b332a2547ee3e5d878891aa73827629b882466302f0824e220ff4c4f3174e9bf",
        # you can override file name, no extension
        name="clase 2 circuits",
        # you can override download path
        path=r"C:\\Users\\marco\\Videos\\Bunny CDN\Circuits\Post Parcial",
    )
    # video.session.close()
    video.download()
